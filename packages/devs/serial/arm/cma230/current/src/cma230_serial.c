...
static bool cma230_serial_set_config(serial_channel *chan, cyg_serial_info_t *config);
...
static bool 
cma230_serial_set_config(serial_channel *chan, cyg_serial_info_t *config)
{
    return cma230_serial_config_port(chan, config, false);
}
