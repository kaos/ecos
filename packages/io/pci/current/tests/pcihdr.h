...
PCIHDR.H: PCI Vendors, Devices, and Class Type information
  ...
  This header created on Fri, 20 Aug 1999 15:30:47 UTC
...
PCI_VENTABLE	PciVenTable [] =
{
	...
	{ 0x1058, "E&TR", "Electronics & Teleccommunication Res" } ,
	...
	{ 0x12CA, "I C Engines", "Integrated Computing Engines" } ,
	...
	{ 0x8008, "Quancom", "Quancom Electronic GmbH" } ,
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x8086, 0x7112, "", "" } ,
	{ 0x8086, 0x7113, "", "" } ,
	{ 0x8086, 0x7180, "82443LX (PAC)", "Host/PCI bridge in 440LX AGP chipset" } ,
	{ 0x8086, 0x7181, "82443LX (PAC)", "AGP device in 440LX AGP chipset" } ,
	{ 0x8086, 0x7190, "", "" } ,
	{ 0x8086, 0x7191, "", "" } ,
	...
	{ 0x9004, 0x7895, "AHA-2940 AHA-394x", "SCSI controller AHA-2940U/UW AHA-394xAU/AUW/AUWD" } ,
	{ 0x9004, 0x7896, "AIC-789x", "SCSI controller" } ,
	{ 0x9004, 0x7897, "AIC-789x", "SCSI controller" } ,
	{ 0x9004, 0x8078, "AIC-7880", "SCSI Ctrlr" } ,
