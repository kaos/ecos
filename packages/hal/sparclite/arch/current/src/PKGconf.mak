#==============================================================================
#
#    makefile === PKGconf.mak
#
#    hal/sparclite/arch/src
#
#==============================================================================
#####COPYRIGHTBEGIN####
#
...
PACKAGE       := hal_sparclite
include ../../../../../pkgconf/pkgconf.mak

LIBRARY       := libtarget.a
COMPILE       := vectors.S vec_ivsr.S vec_xvsr.S \
			context.S icontext.c \
			hal_intr.c hal_boot.c
OTHER_OBJS    := 
