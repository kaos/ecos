...
//      mod_regs_wdt_2.h
//
//      WDT (Watch Dog Timer) Module (type 2) register definitions
//
//=============================================================================
...
//--------------------------------------------------------------------------
#define CYGARC_REG_WTCSR_W              0xffff8610 // 16 bit
#define CYGARC_REG_WTCSR_R              0xffff8610 // 8 bit
#define CYGARC_REG_WTCNT_W              0xffff8610 // 16 bit
#define CYGARC_REG_WTCNT_R              0xffff8611 // 8 bit
#define CYGARC_REG_RSTCSR_W             0xffff8612 // 16 bit
#define CYGARC_REG_RSTCSR_R             0xffff8613 // 8 bit
...
#define CYGARC_REG_WTCSR_CLK_8192       0x0007

#define CYGARC_REG_WTCSR_INIT           (CYGARC_REG_WTCSR_W_MAGIC|0x00)

#define CYGARC_REG_RSTCSR_WOVF          0x0080
