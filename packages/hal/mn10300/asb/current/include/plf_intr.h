...
//      plf_intr.h
//
//      ASB Interrupt and clock support
//
//==========================================================================
...
//               interrupts and the clock for the AM33-2 ASB2303 board.
//              
// Usage:
...
extern void hal_asb_reset( void );
#define CYGHWR_HAL_RESET_DEFINED
#define HAL_PLATFORM_RESET()               hal_asb_reset()
