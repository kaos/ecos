...
static cyg_uint32    kbd_map[8][16] = {
    ...
    {KBD_F6,        KBD_7,          KBD_Y,          KBD_H,  
     ...
     KBD_Empty,     KBD_F9,         KBD_Empty,      KBD_Empty,
     KBD_Empty,     KBD_Empty,      KBD_Empty,      KBD_Empty },
    // Column #7
    {KBD_F7,        KBD_8,          KBD_U,          KBD_J,  
     KBD_M,         KBD_Comma,      KBD_K,          KBD_I,  
     KBD_Empty,     KBD_F8,         KBD_Empty,      KBD_Empty,
     KBD_Empty,     KBD_Empty,      KBD_Empty,      KBD_Empty },
};
...
cyg_start( void )
{
    ...
    *(volatile cyg_uint8 *)PADDR   = 0x00;  // All bits input
    ...
    // Create another thread whose job it is to de-bounce the keyboard and
