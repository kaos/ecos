...
// Date:         1999-04-21
// Purpose:      Cirrus CL7211 platform specific support routines
// Description: 
...
#include <cyg/hal/hal_cl7211.h>       // Platform specific hardware definitions
...
#elif (CYGHWR_HAL_ARM_CL7211_DRAM_SIZE == 16)
#define MMU_TABLES_SIZE  0x4000+0x4000+0x1000    // RAM used for PTE entries
#define DRAM_LA_END      0x01000000-MMU_TABLES_SIZE
#endif
