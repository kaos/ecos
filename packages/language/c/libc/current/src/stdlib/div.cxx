...
//      div.cxx
//
//      ISO C implementation for div() utility function
//
//===========================================================================
//####COPYRIGHTBEGIN####
//                                                                          
...
// Date:          1999-03-02
// Purpose:       Provide implementation of div() from ISO C section 7.10.6.2
// Description:   
// Usage:         
//
//####DESCRIPTIONEND####
...
externC div_t
__div( int __numer, int __denom )
{
    div_t __ret;

    CYG_REPORT_FUNCNAMETYPE( "__div", "quotient: %d");
...
externC div_t
div( int __numer, int __denom ) CYGBLD_ATTRIB_WEAK_ALIAS(__div);
