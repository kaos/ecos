...
//      atol() utility function defined in section 7.10.1.3 of the standard
//
//===========================================================================
//####COPYRIGHTBEGIN####
//
...
externC long
atol( const char *nptr ) CYGPRI_LIBC_WEAK_ALIAS("_atol");


// FUNCTIONS

long
_atol( const char *nptr )
{
    long retval;

    CYG_REPORT_FUNCNAMETYPE( "_atol", "returning %d" );

    CYG_CHECK_DATA_PTR( nptr, "nptr is an invalid pointer!" );

    retval = _strtol( nptr, (char **)NULL, 10 );
